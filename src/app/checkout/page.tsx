...
export default function CheckoutPage() {
  ...
  const [district, setDistrict] = useState('dhaka'); // 'dhaka' | 'outside'
  ...
  const handlePlaceOrder = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      clearCart();
      const mockOrderId = `NL-${Math.floor(100000 + Math.random() * 900000)}`;
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="grid grid-cols-2 gap-3 pt-1">
                        <button
                          ...
                          className={`p-3 border text-xs text-left transition ${
                            district === 'dhaka'
                        ...
                        >
                          ...
                          <div className="text-[11px] text-[#5e5e5b] mt-0.5">৳60 Charge • 2-3 Days</div>
                        </button>
                        ...
                        >
                          ...
                          <div className="text-[11px] text-[#5e5e5b] mt-0.5">৳120 Charge • 3-5 Days</div>
                        </button>
                      </div>
                    </div>

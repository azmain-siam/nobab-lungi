      ...
      <AnimatePresence mode="wait">
        {loading ? (
          ...
          <motion.div
            ...
            transition={{ duration: 0.2 }}
            className="py-16 px-6 text-center space-y-4 bg-[#fbf9f8]/60 border border-dashed border-[#e3e2e2]"
          >
            ...
            <div className="pt-2">
              <Link
                href="/collections"
                className="inline-flex items-center gap-2 px-6 py-3 bg-[#1b1c1c] text-white text-xs font-semibold uppercase tracking-wider hover:bg-black active:scale-95 transition shadow-xs"
              >
                <ShoppingBag className="h-3.5 w-3.5 stroke-[1.5]" />
                Explore Collection
              </Link>

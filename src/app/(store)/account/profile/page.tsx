    ...
    <Section variant="default" className="py-10 lg:py-16">
      <Container>
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-start">
          ...
          <div className="flex-1 bg-white border border-[#e3e2e2] p-6 sm:p-8 space-y-8">
            ...
            {loading ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="space-y-4">
                  <h3 className="text-xs font-bold uppercase tracking-wider text-[#1b1c1c] flex items-center gap-2 border-b border-[#e3e2e2] pb-2">
